...
<v-container>
    ...
    <v-flex xs12>
      <v-card>
        <v-toolbar color="blue" dark>
          <v-toolbar-title>Submitted State</v-toolbar-title>
        </v-toolbar>
        <v-list two-line subheader>
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.submitted.requireApproval"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Require Approval</v-list-tile-title>
              <v-list-tile-sub-title>Requires the submission to enter the Reviewing state automatically</v-list-tile-sub-title>
            </v-list-tile-content>
          </v-list-tile>
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.submitted.sendNotificationToCollaborators"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notifications to Collaborators</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to all collaborators</v-list-tile-sub-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.submitted.sendNotificationToSubmitter"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notification to Submitter</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to the submitter</v-list-tile-sub-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.submitted.sendAdditionalNotifications"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Additional Notifications</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to the emails below</v-list-tile-sub-title>
          ...
          <v-list-tile avatar v-if="workflow.submitted.sendAdditionalNotifications">
            <v-list-tile-action>
              <v-icon>send</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-select
                  ...
                  append-icon=""
                  clearable
                  v-model="workflow.submitted.alsoNotify">
                  <template slot="selection" slot-scope="data">
                    <v-chip
                      close
                      @input="removeEmail(workflow.submitted.alsoNotify, data.item)"
                      :selected="data.selected">
                      <strong>{{ data.item }}</strong>
                    </v-chip>
                  </template>
  ...
  <v-layout row v-if="workflow.submitted.requireApproval">
    <v-flex xs12>
      <v-card>
        <v-toolbar color="orange" dark>
          <v-toolbar-title>Reviewing State</v-toolbar-title>
        </v-toolbar>
        <v-list two-line subheader>
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.reviewing.sendNotificationToApprovers"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notifications to Approvers</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to all approvers</v-list-tile-sub-title>
            </v-list-tile-content>
          </v-list-tile>
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.reviewing.sendNotificationToCollaborators"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notifications to Collaborators</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to all collaborators</v-list-tile-sub-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.reviewing.sendNotificationToSubmitter"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notification to Submitter</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to the submitter</v-list-tile-sub-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.reviewing.sendAdditionalNotifications"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Additional Notifications</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to the emails below</v-list-tile-sub-title>
          ...
          <v-list-tile avatar v-if="workflow.reviewing.sendAdditionalNotifications">
            <v-list-tile-action>
              <v-icon>send</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-select
                  ...
                  append-icon=""
                  clearable
                  v-model="workflow.reviewing.alsoNotify">
                  <template slot="selection" slot-scope="data">
                    <v-chip
                      close
                      @input="removeEmail(workflow.reviewing.alsoNotify, data.item)"
                      :selected="data.selected">
                      <strong>{{ data.item }}</strong>
                    </v-chip>
                  </template>
          ...
          <v-list-tile avatar>
            ...
            <v-list-tile-content>
              <v-select
                  ...
                  clearable
                  required
                  :rules="[() => workflow.reviewing.approvers.length > 0 || 'You must choose at least one']"
                  :search-input.sync="approverEmail"
                  v-model="workflow.reviewing.approvers">
                  <template slot="selection" slot-scope="data">
                    <v-chip
                      close
                      @input="removeEmail(workflow.reviewing.approvers, data.item)">
          ...
          <v-list-tile avatar>
            ...
            <v-list-tile-content>
              <v-text-field type="number" 
              v-model="workflow.reviewing.minimumApprovals" 
              label="Minimum number of approvals"
              hint="After the minimum number of approvals is met, the submission will automatically move to the Approved state.  If the submission receives more rejections than appovals, the submission moves to the Rejected state."
              :rules="[() => workflow.reviewing.approvers.length >= workflow.reviewing.minimumApprovals || 'The number of approvals should not exceed the number of approvers.']" ></v-text-field>
            </v-list-tile-content>
          </v-list-tile>
        </v-list>
      </v-card>
    ...
    <v-flex xs12>
      <v-card>
        <v-toolbar color="green" dark>
          <v-toolbar-title>Approved State</v-toolbar-title>
        </v-toolbar>
        <v-list two-line subheader>
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.approved.sendNotificationToCollaborators"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notifications to Collaborators</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to all collaborators</v-list-tile-sub-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.approved.sendNotificationToSubmitter"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notification to Submitter</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to the submitter</v-list-tile-sub-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.approved.sendAdditionalNotifications"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Additional Notifications</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to the emails below</v-list-tile-sub-title>
          ...
          <v-list-tile avatar v-if="workflow.approved.sendAdditionalNotifications">
            <v-list-tile-action>
              <v-icon>send</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-select
                  ...
                  append-icon=""
                  clearable
                  v-model="workflow.approved.alsoNotify">
                  <template slot="selection" slot-scope="data">
                    <v-chip
                      close
                      @input="removeEmail(workflow.approved.alsoNotify, data.item)"
                      :selected="data.selected">
                      <strong>{{ data.item }}</strong>
                    </v-chip>
                  </template>
    ...
    <v-flex xs12>
      <v-card>
        <v-toolbar color="red" dark>
          <v-toolbar-title>Rejected State</v-toolbar-title>
        </v-toolbar>
        <v-list two-line subheader>
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.rejected.sendNotificationToCollaborators"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notifications to Collaborators</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to all collaborators</v-list-tile-sub-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.rejected.sendNotificationToSubmitter"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Notification to Submitter</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to the submitter</v-list-tile-sub-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-action>
              <v-checkbox v-model="workflow.rejected.sendAdditionalNotifications"></v-checkbox>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-list-tile-title>Send Additional Notifications</v-list-tile-title>
              <v-list-tile-sub-title>Sends a notification to the emails below</v-list-tile-sub-title>
          ...
          <v-list-tile avatar v-if="workflow.rejected.sendAdditionalNotifications">
            <v-list-tile-action>
              <v-icon>send</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
              <v-select
                  ...
                  append-icon=""
                  clearable
                  v-model="workflow.rejected.alsoNotify">
                  <template slot="selection" slot-scope="data">
                    <v-chip
                      close
                      @input="removeEmail(workflow.rejected.alsoNotify, data.item)"
                      :selected="data.selected">
                      <strong>{{ data.item }}</strong>
                    </v-chip>
                  </template>
