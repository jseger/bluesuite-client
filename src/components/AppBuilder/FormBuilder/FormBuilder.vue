                        ...
                        <v-card>
                          <v-card-text>
                            ...
                            <v-flex xs12>
                              ...
                              required
                              v-model="field.name" v-if="field.type !== 'label'"></v-text-field>
                            </v-flex>
                            <v-checkbox 
                            label="Required"
                            v-model="field.required" v-if="field.type !== 'label'"></v-checkbox>
                            <v-checkbox 
                            label="Show Preview"
                            ...
                            <v-radio-group label="Label Type" v-model="field.labelColor" v-if="field.type === 'label'">
                            ...
                            :items="icons"
                            clearable
                            autocomplete v-if="field.type === 'label'"
                            v-model="field.labelIcon"></v-select>
